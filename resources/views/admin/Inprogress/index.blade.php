    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Sop">
                ...
                <tbody>
                    @foreach($inprogress_sop as $inprogress_sop)
                        <tr data-entry-id="{{ $inprogress_sop->id }}">
                            <td>
                            ...
                            <td>
                                {{$inprogress_sop->sop_title}}
                            </td>
                            <td>
                                {{$inprogress_sop->business_unit}}
                            </td>
                            <td>
                                {{ $inprogress_sop->uploaded_by  }}
                            </td>
                            <td>
                                {{$inprogress_sop->created_at}}
                            </td>
                            <td>
                                {{$inprogress_sop->effective_date}}
                            </td>
                            <td>
                                {{ $inprogress_sop->status  }}
                            </td>
                            <td>
                            </td>
                        </tr>
