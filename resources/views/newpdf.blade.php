...
require_once dirname('../public\library\examples\tcpdf_include.php');
require_once dirname('../public\library\tcpdf.php');
...
$procedure='<h2>PROCEDURE</h2>
          ...
          $procedure.='<tr>
            ...
            <td style="font-size:12px; vertical-align: top;"><b>'.$a++.'-'.$new.'</b></td>
...
$imges=file_get_contents('C:/xampp/htdocs/Sop new/storage/app/public/'.$img);
